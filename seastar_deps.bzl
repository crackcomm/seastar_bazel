...
def seastar_deps():
    ...
    if not native.existing_rule("fmtlib"):
        http_archive(
            name = "fmtlib",
    ...
    if not native.existing_rule("yaml-cpp"):
        http_archive(
            name = "yaml-cpp",
    ...
    if not native.existing_rule("colm"):
        http_archive(
            name = "colm",
    ...
    if not native.existing_rule("ragel"):
        http_archive(
            name = "ragel",
    ...
    if not native.existing_rule("cryptopp"):
        http_archive(
            name = "cryptopp",
    ...
    if not native.existing_rule("sctp"):
        http_archive(
            name = "sctp",
    ...
    if not native.existing_rule("systemtap-sdt"):
        http_archive(
            name = "systemtap-sdt",
    ...
    if not native.existing_rule("xfs"):
        http_archive(
            name = "xfs",
    ...
    if not native.existing_rule("readerwriterqueue"):
        http_archive(
